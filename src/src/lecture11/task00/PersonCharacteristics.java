...
import lecture11.task00.education.*;
...
public class PersonCharacteristics {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            List<SocialInsuranceRecord> records = parseSocialInsuranceLine(line2);
    ...
    static List<SocialInsuranceRecord> parseSocialInsuranceLine(String line) {
